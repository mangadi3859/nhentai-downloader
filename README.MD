...
In order to use this extension, you must have [JustCors](https://justcors.com) url to work. You can use **temporary URL** or use **permanent URL** provided by JustCors.
